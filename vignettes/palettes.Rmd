...
```{r inbo-palette, fig.height = show_height, fig.cap = "The available colors in inbo_palette()"}
show_palette(inbo_palette())
```

```{r inbo-palette-demo, fig.cap = "All colours of inbo_palette() side by side."}
demo_palette(inbo_palette())
```

## `vlaanderen_palette()`

```{r vlaanderen-palette, fig.height = show_height, fig.cap = "Available colours of vlaanderen_palette()"}
show_palette(vlaanderen_palette())
```

```{r vlaanderen-palette-demo, fig.cap = "All colours of vlaanderen_palette() side by side."}
...
```{r traffic-palette-9, fig.height = show_height, fig.cap = "The available colours in traffic_palette(9)"}
...
```{r traffic-palette-3, fig.height = show_height, fig.cap = "The available colours in traffic_palette(3)"}
...
```{r inbo-named, fig.height = show_height, echo = TRUE, fig.cap = "The available named colours for INBO."}
inbo_named <- c(
  ...
  inbo_rood, inbo_grijs, inbo_bruinrood
)
show_palette(inbo_named)
```

```{r inbo-named-demo, fig.cap = "The named colours for INBO side by side."}
demo_palette(inbo_named)
```

## Flanders colours

```{r vl-named, fig.height = show_height, echo = TRUE, fig.cap = "The available named colours for Flanders."}
vl_named <- c(
...
```{r vl-named-demo, fig.cap = "The named colours for Flanders side by side."}
...
```{r inbo-palette-2, fig.height = show_height, fig.cap = "The actual palette for INBO."}
show_palette(inbo_palette())
```
...
```{r vlaanderen-palette-2, fig.height = show_height, fig.cap = "The actual palette for Flanders."}
show_palette(vlaanderen_palette())
```
...
```{r inbo-named-2, fig.height = show_height, fig.cap = "The actual named colours for INBO."}
show_palette(inbo_named)
```
...
```{r vl-named-2, fig.height = show_height, fig.cap = "The actual named colours for Flanders."}
show_palette(vl_named)
```
