...
#'- inbo.hoofd
#'- inbo.steun.donkerroos
#'- inbo.steun.blauw
#'- inbo.steun.geelgroen
#'- inbo.oranje
#'- inbo.rood
#'- inbo.bruinrood
#'- inbo.grijs
...
#'-`page.height` Maximal height of a figuur (in inch)
#'-`page.width` Width of a figure covering two columns (in inch)
#'-`column.width` Width of a figure covering one column (in inch)
#'-`medium.width` Width of a figure covering 1.5 columns (in inch)
#'@docType data
