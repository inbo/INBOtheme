...
theme_inbo2014 <- function (base_size = 12, base_family = "") {
  theme(
    ...
    strip.text = element_text(size = rel(0.8), colour = inbo.hoofd), 
    ...
    strip.text.x = element_text(colour = inbo.steun.donkerroos), 
    strip.text.y = element_text(angle = -90, colour = inbo.steun.donkerroos), 
